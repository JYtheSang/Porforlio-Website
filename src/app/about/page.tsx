  ...
  return (
    <main>
      <div className="max-w-[1250px] w-full mx-auto px-6 md:px-24 pt-16 pb-0">
        ...
        <div className="w-full aspect-[3/2] rounded-2xl overflow-hidden bg-[#e4e4e7] mb-10">
          <Image
            src="/about-photo.jpg"
            alt="Jie Yang"
            width={800}
        ...
        <p className="text-[11px] font-bold tracking-[1.5px] uppercase text-[#71717a] mb-4">
          About Me
        </p>

        <div className="flex flex-col gap-5 text-base leading-7 text-[#64748b]">
          <p>
          ...
          <p>
            Jie earned a <strong className="text-[#0a0a0a] font-semibold">Bachelor&apos;s degree in Industrial Design from Tongji University</strong>, completing his first <strong className="text-[#0a0a0a] font-semibold">Master's degree in Design from the Institute of Design (IIT)</strong>. He has worked as <strong className="text-[#0a0a0a] font-semibold">product designer</strong> at <strong className="text-[#0a0a0a] font-semibold">SAP</strong> and <strong className="text-[#0a0a0a] font-semibold">PayPal</strong>, contributing to both business-facing and consumer-facing digital products and cross-functional teams.
          </p>
          <p>
            As his work evolved, Jie became increasingly interested in how emerging technologies can be applied to improve people&apos;s lives in more meaningful and natural ways. He is currently pursuing a second <strong className="text-[#0a0a0a] font-semibold">Master&apos;s degree in Computer Science at Georgia Tech (OMSCS)</strong> to deepen his technical understanding and strengthen the bridge between design and engineering.
          </p>
        </div>
          ...
          <a
            ...
            download
            className="inline-flex items-center mt-10 px-5 py-2.5 bg-[#0a0a0a] text-[#ffffff] text-[13px] font-bold tracking-[1px] uppercase rounded-lg hover:opacity-80 transition-opacity"
          >
            Resume
          </a>
        </div>
