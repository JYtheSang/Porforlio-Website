      ...
      <div className="max-w-[900px] mx-auto px-6">
        ...
        <div className="pt-16 pb-16 border-b border-[#e4e4e7]">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight leading-tight text-[#0a0a0a] mb-5">
            ML-Driven<br /><span className="text-[#4a6cf7]">Algorithmic Trading</span>
          </h1>
          <p className="text-lg text-[#52525b] max-w-[620px] mb-10">
            ...
            <strong className="text-[#10b981]">+42 percentage points</strong> in-sample.
          </p>
        ...
        <section id="overview" className="py-16 border-b border-[#e4e4e7]">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-[#0a0a0a] mb-5">What this project is</h2>
          <p className="text-[#52525b] leading-7 mb-4">
            This is a semester-long project for Georgia Tech&apos;s <strong className="text-[#0a0a0a]">CS 7646 – Machine Learning for Trading</strong>,
          ...
          <p className="text-[#52525b] leading-7 mb-6">
            The system spans three interconnected layers: a <strong className="text-[#0a0a0a]">custom ML engine</strong> (decision trees, random forests),
            a <strong className="text-[#0a0a0a]">technical indicator library</strong>, and two <strong className="text-[#0a0a0a]">trading strategies</strong> — one
        ...
        <section id="approach" className="py-16 border-b border-[#e4e4e7]">
          <div className="text-[11px] font-mono text-[#4a6cf7] uppercase tracking-[0.12em] mb-3.5">02 — Technical Approach</div>
          <h2 className="text-3xl font-bold tracking-tight text-[#0a0a0a] mb-8">Three-phase pipeline</h2>

          <div className="flex flex-col gap-6">

            {/* Phase 01 */}
            <div className="bg-[#f4f4f5] border border-[#e4e4e7] rounded-xl p-7 grid grid-cols-[56px_1fr] gap-6 items-start">
              <div className="w-11 h-11 bg-[#4a6cf71a] border border-[#4a6cf740] rounded-lg flex items-center justify-center font-mono text-[15px] font-bold text-[#4a6cf7]">01</div>
              <div>
                <h3 className="text-[17px] font-semibold text-[#0a0a0a] mb-2">Custom Machine Learning Engine</h3>
                <p className="text-[#52525b] text-[15px] leading-7 mb-3">Built decision tree learners from scratch using only NumPy arrays — no scikit-learn or other ML libraries.</p>
                <ul className="list-disc ml-5 text-[15px] text-[#52525b] space-y-1.5">
                  <li><strong className="text-[#0a0a0a]">DTLearner:</strong> Splits on the feature with highest absolute Pearson correlation to the target. Tree stored as a flat NumPy array for cache efficiency.</li>
                  <li><strong className="text-[#0a0a0a]">RTLearner:</strong> Splits on a randomly selected feature — faster to train, reduces variance at the cost of slight bias.</li>
                  <li><strong className="text-[#0a0a0a]">BagLearner:</strong> Bootstrap aggregation wrapper; trains <em>n</em> base learners on resampled data and averages predictions. Configured with 150 RT bags.</li>
                  <li><strong className="text-[#0a0a0a]">Experiments:</strong> Measured RMSE and R² vs. leaf size to characterize overfitting. Confirmed bagging reduces overfitting: in-sample RMSE rose while out-of-sample RMSE held stable.</li>
                </ul>
              </div>
            </div>
            ...
            {/* Phase 02 */}
            <div className="bg-[#f4f4f5] border border-[#e4e4e7] rounded-xl p-7 grid grid-cols-[56px_1fr] gap-6 items-start">
              <div className="w-11 h-11 bg-[#4a6cf71a] border border-[#4a6cf740] rounded-lg flex items-center justify-center font-mono text-[15px] font-bold text-[#4a6cf7]">02</div>
              <div>
                <h3 className="text-[17px] font-semibold text-[#0a0a0a] mb-2">Technical Indicator Library</h3>
                <p className="text-[#52525b] text-[15px] leading-7 mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5">
                  {[
                    ...
                    <div key={ind.name} className="bg-[#ffffff] border border-[#e4e4e7] rounded-lg p-4">
                      <div className="text-[13px] font-mono text-[#8b5cf6] mb-1.5">{ind.name}</div>
                      <p className="text-[14px] text-[#52525b] m-0">{ind.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* Phase 03 */}
            <div className="bg-[#f4f4f5] border border-[#e4e4e7] rounded-xl p-7 grid grid-cols-[56px_1fr] gap-6 items-start">
              <div className="w-11 h-11 bg-[#4a6cf71a] border border-[#4a6cf740] rounded-lg flex items-center justify-center font-mono text-[15px] font-bold text-[#4a6cf7]">03</div>
              <div>
                <h3 className="text-[17px] font-semibold text-[#0a0a0a] mb-2">Dual Trading Strategies</h3>
                <p className="text-[#52525b] text-[15px] leading-7 mb-3">Two strategies were built and compared head-to-head — one rule-based, one ML-driven.</p>
                <ul className="list-disc ml-5 text-[15px] text-[#52525b] space-y-2">
                  <li>
                    <strong className="text-[#0a0a0a]">Manual Strategy:</strong> A weighted voting system across all four indicators.
                  ...
                  <li>
                    <strong className="text-[#0a0a0a]">Strategy Learner:</strong> A BagLearner (150 RTLearner bags, leaf_size=5) trained on the
        ...
        <section id="results" className="py-16 border-b border-[#e4e4e7]">
          <div className="text-[11px] font-mono text-[#4a6cf7] uppercase tracking-[0.12em] mb-3.5">03 — Results</div>
          <h2 className="text-3xl font-bold tracking-tight text-[#0a0a0a] mb-5">Performance across three strategies</h2>
          ...
          <div className="grid md:grid-cols-2 gap-5 mb-8">
            {[
              ...
              <div key={table.title} className="bg-[#f4f4f5] border border-[#e4e4e7] rounded-xl p-6">
                <h3 className="text-[17px] font-semibold text-[#0a0a0a] mb-4">{table.title}</h3>
                <table className="w-full text-[14px]">
                  <thead>
                    <tr>
                      {["Metric", "Manual", "Benchmark"].map((h) => (
                        <th key={h} className="text-left text-[11px] font-mono uppercase tracking-widest text-[#52525b] pb-3 border-b border-[#e4e4e7]">{h}</th>
                      ))}
                    </tr>
                  </thead>
                  <tbody>
                    {table.rows.map(([label, val1, c1, val2, c2]) => (
                      <tr key={label} className="border-b border-[#e4e4e799]">
                        <td className="py-2.5 text-[#0a0a0a] font-medium">{label}</td>
                        <td className={`py-2.5 font-mono ${c1 === "green" ? "text-[#10b981]" : c1 === "red" ? "text-[#ef4444]" : "text-[#4a6cf7]"}`}>{val1}</td>
                        <td className={`py-2.5 font-mono ${c2 === "green" ? "text-[#10b981]" : c2 === "red" ? "text-[#ef4444]" : "text-[#4a6cf7]"}`}>{val2}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          {/* Experiment 1 charts */}
          <div className="bg-[#f4f4f5] border border-[#e4e4e7] rounded-xl p-6 mb-5">
            <h3 className="text-[17px] font-semibold text-[#0a0a0a] mb-3">Experiment 1 — Strategy Learner vs Manual Strategy vs Benchmark</h3>
            <p className="text-[#52525b] text-[15px] leading-7 mb-5">
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-[#f4f4f5] border border-[#e4e4e7] rounded-lg overflow-hidden">
                <PortfolioPerformanceChart inSample />
                <p className="text-[13px] text-[#52525b] px-4 py-4 leading-relaxed border-t border-[#e4e4e7] italic">
          ...
          {/* Experiment 2 */}
          <div className="bg-[#f4f4f5] border border-[#e4e4e7] rounded-xl p-6 mb-5">
            <h3 className="text-[17px] font-semibold text-[#0a0a0a] mb-3">Experiment 2 — Market Impact Sensitivity</h3>
            <p className="text-[#52525b] text-[15px] leading-7 mb-5">
          ...
          <div className="bg-[#f4f4f5] border border-[#e4e4e7] rounded-xl p-6">
            <h3 className="text-[17px] font-semibold text-[#0a0a0a] mb-3">Theoretical Upper Bound</h3>
            <p className="text-[#52525b] text-[15px] leading-7 mb-5">
              As a reference ceiling, a <strong className="text-[#0a0a0a]">Theoretically Optimal Strategy (ToC)</strong> was computed using
            ...
            <table className="w-full text-[14px] mb-5">
              ...
              <tbody>
                {[
                  ...
                  <tr key={label} className="border-b border-[#e4e4e799]">
                    <td className="py-2.5 text-[#0a0a0a] font-medium">{label}</td>
                    <td className="py-2.5 font-mono text-[#10b981]">{opt}</td>
                    <td className="py-2.5 font-mono text-[#4a6cf7]">{bench}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        {/* ── Section: Takeaways ── */}
        <div className="pt-16">
          <div className="text-[11px] font-mono text-[#4a6cf7] uppercase tracking-[0.12em] mb-3.5">04 — Takeaways</div>
          <h2 className="text-3xl font-bold tracking-tight text-[#0a0a0a] mb-10">What this taught me</h2>
          <div className="flex flex-col gap-6">
            {[
