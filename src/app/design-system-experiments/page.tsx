    ...
    <main className="pb-24">
      ...
      <div className="mt-20">
        ...
        <div className="max-w-[1250px] mx-auto px-6 mt-10 flex justify-center">
          <div className="w-full max-w-[1024px] overflow-hidden rounded-2xl border border-[#e4e4e7] bg-[#f4f4f5]">
            <div className="flex items-center justify-between gap-4 px-4 py-3 border-b border-[#e4e4e7] bg-[#f4f4f5]">
              <p className="text-sm font-medium tracking-[-0.15px] text-[#0a0a0a]">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 text-xs font-semibold text-[#3b82f6] hover:opacity-80 transition-opacity shrink-0"
              >
                Open in Figma
      ...
      <div className="mt-20">
        <SectionText title="Building it in Cursor">
          ...
          <ol className="list-decimal pl-5 flex flex-col gap-4 marker:text-[#71717a]">
            <li>
              <strong className="text-[#0a0a0a] font-semibold">Set up React.</strong> Start a Vite +
              React + TypeScript project in Cursor (<code className="text-[#52525b]">npm create vite@latest</code>
              ). This gives you a fast dev server, a real component tree, and a place to iterate on
              behavior — not just layout.
            </li>
            <li>
              <strong className="text-[#0a0a0a] font-semibold">Share the Figma link.</strong> Paste the
            ...
            <li>
              <strong className="text-[#0a0a0a] font-semibold">Fine-tune design details in code.</strong>{" "}
            ...
            <li>
              <strong className="text-[#0a0a0a] font-semibold">Add Storybook.</strong> Run{" "}
              <code className="text-[#52525b]">npx storybook@latest init</code> to generate stories
            ...
            <li>
              <strong className="text-[#0a0a0a] font-semibold">Save the work on GitHub.</strong> Push the
      ...
      <div className="mt-20">
        <SectionText title="Reviewing in Storybook">
          <p>
            ...
            <strong className="text-[#0a0a0a] font-semibold">inspect, test, and share</strong> — not a
